...
public final class LogUtils {
    ...
    private static final int OBJ2JSON = 0xF6;
    ...
    public static class Builder {
        ...
        public Builder(Context app) {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = app.getExternalCacheDir() + File.separator + "log" + File.separator;
            } else {
                dir = app.getCacheDir() + File.separator + "log" + File.separator;
            }
        }
    ...
    //sumerlin
    public static void obj2Json(Object object) {
        log(OBJ2JSON, sGlobalTag, object);
    }
